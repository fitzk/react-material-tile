...
// @TODO: add titleStyle & subtitleStyle to docs
const HeaderTitle = ({ title, subtitle, titleStyle, subtitleStyle }) => {
	let _subtitle = <Subtitle subtitleStyle={ subtitleStyle }>
                   { subtitle }
                 </Subtitle>
