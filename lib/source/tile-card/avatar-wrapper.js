...
const AvatarWrapper = props => {
	...
	const defaultAvatarStyle = _defaultAvatarStyle(props.backgroundColor, props.tileHeight, props.tileWidth, props.marginRight, props.marginLeft, props.avatarStyle, props.padding)
